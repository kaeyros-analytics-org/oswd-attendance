...
const SignupModule = () => {
  ...
  return (
    <div className='relative bg-gray-100 h-[100%] flex flex-col items-center justify-center'>
      <h1 className='text-center text-bold text-[1rem] sm:text-[2rem] mb-[1rem] sticky top-0 bg-white text-black w-full flex justify-center'>Welcome to OSWD BootCamp Signup Form</h1>
